            ...
            <div className="pointer-events-none opacity-60">
              ...
              {field.type === 'file' && (
                <div className="px-3 py-4 bg-gray-50 border-2 border-dashed border-gray-200 rounded-lg text-center text-xs text-gray-400">
                  ...
                  {field.accept && <span className="block text-[10px] text-gray-400 mt-1">Accepts: {field.accept}</span>}
                  {field.maxFiles && <span className="block text-[10px] text-gray-400">Max: {field.maxFiles} file(s)</span>}
                </div>
              )}
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-indigo-500 font-mono"
                  />
                  <p className="text-[10px] text-gray-400 mt-1">Comma-separated extensions or MIME types</p>
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdate({ maxFiles: e.target.value ? parseInt(e.target.value) : undefined })}
                    min={1}
                    max={50}
